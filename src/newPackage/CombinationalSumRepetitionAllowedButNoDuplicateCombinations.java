...
public class CombinationalSumRepetitionAllowedButNoDuplicateCombinations {
	...
	private static void findCombinations(int n, int[] nums, int currSum, List<Integer> numsList,int start) {
		...
		for(int i=start;i < nums.length ; i++ ) {
			...
			count++ ;
			findCombinations(n,nums,currSum,numsList,i) ;
