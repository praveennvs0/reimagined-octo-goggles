...
public class Task2 {
	...
	public static char[] interval = new char[10000] ;
	...
	public static void main(String args[]) {
		...
		int number = leastInterval(tasks,1) ;
	...
	private static int leastInterval(char[] tasks, int n) {
		...
		taskMap = sortMapByValue(taskMap) ;
	...
	public static Map<Character,Integer> sortMapByValue(Map<Character,Integer> taskMap) {
		
	  Set<Entry<Character, Integer>> set = taskMap.entrySet();
	...
	private static int fillInIntervalArray(char[] interval, Character ch,
		...
		if(ch=='E')
			System.out.println("frequency : " + currFreq) ;
